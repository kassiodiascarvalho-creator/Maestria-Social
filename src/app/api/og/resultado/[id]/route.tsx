  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {/* Nome */}
        <div style={{ display: 'flex', fontSize: 28, color: '#7a6e5e', marginBottom: 12, fontFamily: 'sans-serif' }}>
          {lead.nome}
        </div>

        {/* Título */}
        <div style={{ display: 'flex', fontSize: 56, fontStyle: 'italic', lineHeight: 1.05, marginBottom: 24 }}>
          Quociente Social
        </div>
